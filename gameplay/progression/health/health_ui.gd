...
const Health = preload("res://gameplay/progression/health/health.gd")
const HealthSegment = preload("res://gameplay/progression/health/health_segment.gd")
const SEGMENT_SCENE = preload("res://gameplay/progression/health/health_segment.tscn")
