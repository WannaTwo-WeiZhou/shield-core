...
const AbilityDefinition = preload("res://gameplay/abilities/core/ability_definition.gd")
const AbilityInstance = preload("res://gameplay/abilities/core/ability_instance.gd")
const ModifierPipeline = preload("res://gameplay/abilities/core/modifier_pipeline.gd")
const SynergyResolver = preload("res://gameplay/abilities/core/synergy_resolver.gd")
...
const CONFIG_PATH := "res://gameplay/abilities/config/abilities_config.json"
